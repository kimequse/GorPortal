<?php
    ...
    $edi = $_SESSION['editer'];
    $select = $connect->query("SELECT * FROM `problems` WHERE `ID`='$edi'");
...
<html lang="ru">
    ...
    <header>
        ...
        <a href="LKab.html"><input class="vih" type="button" value=" назад "></a>
    </header>
    <div class="cont">
        <div class="im">
            <p class="text">Редактирование заявки</p>
        </div>
    </div>
    <form action="settings/redcreate.php" method="post">
    <div class="opis">
        <div class="opr">
            <p class="gl1">описание проблемы*</p>
            <p class="ml1">кратко опишите вашу проблему</p>
        </div>
        <input name="prob" class="st1" type="text" value="<?= $array['problema']?>">
    ...
    <div class="kat">
        ...
        <div>
            <select class="st2" name="kat" id="select" value="<?= $array['kat']?>">
    ...
    <div class="nzv">
        ...
        <input name="problema" class="st3" type="text" class="fap" value="<?= $array['nameofprob']?>">
    </div>
